...
namespace BowlThemUp.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PlayerID,PlayerName,ShoeSize,MyProperty,Gender")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlayerID,PlayerName,ShoeSize,MyProperty,Gender")] Player player)
        {
